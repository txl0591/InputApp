...
public class DataInfoDBHelper extends SQLiteOpenHelper{
	
	public static final String tag = "DataInfoDBHelper";
	
	public static final String DATABASEV00_NAME = "DataInfo.db";
	public static final String DATABASEV10_NAME = "DataInfoV10.db";
	
	public static final String DATABASE_NAME = DATABASEV10_NAME;
	...
	public static final String TBL_GLLX = "骨料类型";
	public static final String TBL_QHDJ = "强度等级";	
	...
	public DataInfoDBHelper(Context context) {
	...
	public void addrecord(String Timer,
    	...
    	mContentValues.put(TBL_GLLX, GLLX);
    	mContentValues.put(TBL_QHDJ, QHDJ);
